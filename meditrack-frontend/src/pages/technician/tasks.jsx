  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-7xl mx-auto">
        <WelcomeBanner subtitle="Complete doctor-assigned technician tasks, update progress, and log notes for urgent workflows." />

        <div className="mt-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900">Assigned Tasks</h1>
            <p className="mt-2 text-slate-600">Track doctor-created technician tasks and mark them as pending, in-progress, or completed.</p>
          </div>
